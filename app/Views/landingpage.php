...
<body>
  ...
  <div style="display: flex; align-items: center;">
    <i class="fas fa-heartbeat" style="font-size: 40px; color: #002147;"></i>
    <h3 style="color: #002147; font-size: 20px; margin-left: 10px;">Klinik Pelita Bangsa</h3>
  </div>
    <img src="<?= base_url(); ?>" width="150px" alt="" />
    ...
    <nav class="navbar">
      ...
      <?php if (session()->get('log_in') == true) { ?>
        <a href="<?= base_url(); ?>/login">Konsultasi</a>
      <?php } else { ?>
  ...
  <section class="home" id="home">
    ...
    <div class="content">
      ...
      <?php } else { ?>
        <a href="<?= base_url(); ?>/login" onclick="return confirm('Anda harus login terlebih dahulu')" class="btn"> Konsultasi Sekarang <span class="fas fa-chevron-right"></span> </a>
      <?php } ?>
      <?php if (session()->get('log_in') == true) { ?>
      <a href="<?= base_url() ?>/daftar/dpoli" class="btn"> Daftar <span class="fas fa-chevron-right"></span> </a>
      <?php } else { ?>
        <a href="<?= base_url(); ?>/login" onclick="return confirm('Anda harus login terlebih dahulu')" class="btn"> daftar Sekarang <span class="fas fa-chevron-right"></span> </a>
      <?php } ?>
    </div>
  </section>
  ...
  <!-- <h1 class="heading"><span>Fac</span>ility</h1> -->
  ...
  <section class="about" id="about">
    ...
    <div class="row">
      ...
      <div class="content">
        ...
        <p>Kami memberikan perawatan medis berkualitas dan peduli. Layanan holistik dengan tim terampil dan peralatan modern. Rawat inap, rawat jalan, operasi, rehabilitasi, dan gawat darurat 24 jam.</p>
        <p>Keamanan dan kenyamanan pasien kami utamakan. Lingkungan yang hangat dan ramah untuk pemulihan yang optimal.</p>
        <p>Temukan informasi lengkap tentang layanan kami, jadwal dokter, dan program kesehatan kami di website kami.</p>
  ...
  <section class="footer">
    <div class="box-container">
      ...
      <div class="box">
        ...
        <p>Jangan ragu untuk menjelajahi website kami dan temukan informasi yang berguna tentang layanan kami, jadwal dokter, fasilitas, dan program kesehatan kami. Kami berharap dapat memberikan Anda pengalaman yang menyenangkan dalam menelusuri halaman kami.</p>
      </div>
      ...
      <div class="box">
        ...
        <a href="https://wa.me/082311703028"> <i class="fas fa-phone"></i> +62 823-1170-3028 </a>
        <a href="#"> <i class="fas fa-envelope"></i> Example@gmail.com </a>
        <!-- <a href="#"> <i class="fas fa-envelope"></i> anasbhai@gmail.com </a> -->
        <a href="#"> <i class="fas fa-map-marker-alt"></i> Jl. Inspeksi Kalimalang Tegal Danas Arah Deltamas, Cibatu, Cikarang</a>
      </div>
    ...
    <div class="credit">created by <span>@2023</span> Mahasiswa Unversitas Pelita Bangsa</div>
  </section>
